...
class Config(object):
    def __init__(self, dataset):
        ...
        if self.dataset == 'sunrgbd':
            # Resolve paths relative to the Implicit3DUnderstanding package root to avoid CWD issues
            _pkg_root = os.path.abspath(os.path.join(os.path.dirname(__file__), '..'))
            self.metadata_path = os.path.join(_pkg_root, 'data', 'sunrgbd')
            ...
            self.evaluation_path = os.path.join(_pkg_root, 'evaluation', 'sunrgbd')
