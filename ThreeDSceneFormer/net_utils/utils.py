...
class CheckpointIO(object):
    ...
    def finetune(self):
        ...
        for weight_path in weight_paths:
            if not os.path.exists("ThreeDSceneFormer/" + weight_path):
                self.cfg.log_string('Warning: finetune failed: the weight path %s is invalid. Begin to train from scratch.' % ("ThreeDSceneFormer/" + weight_path))
            else:
                self.load("ThreeDSceneFormer/" + weight_path, 'net')
